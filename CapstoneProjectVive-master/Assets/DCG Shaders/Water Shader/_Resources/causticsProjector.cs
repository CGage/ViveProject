...
public class causticsProjector : MonoBehaviour {
	...
	// storage variable for the height cut of the caustics... getting terrain height from Terrain Generator
	public float causticHeightCut;
	public GameObject Terrain;

	void Start () {
		Invoke ("GetHeight", 0.5f);
	...
	void Update () {
		...
		if (p) 
		{
			...
			if (setParameters) 
			{
				...
				p.material.SetFloat ("_UnderwaterCut", GetHeight());
			}
...
//			print("Projector Found !");
	...
	public float GetHeight () {
		causticHeightCut = Terrain.GetComponent <RandomTerrainGenerator> ().hillsHeight;
		return causticHeightCut;
	}
}
