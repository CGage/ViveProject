...
public class DisplayTaggedArea5 : MonoBehaviour {
...
//			Debug.Log ("length of Contents array - 10: " + (lengthContents - 10));
	...
	//			Debug.Log (counter);
			...
			string tempString1 = lastTen [0];
			string tempString2 = lastTen [1];
